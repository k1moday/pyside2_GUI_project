...
class Graph:
    ...
    def adjacency_matrix(self):
        ...
        col = np.array(
            [nodeIndexDict[src_key] for src_key, valdict in self.edges.iteritems() for trgt_key in valdict.iterkeys()])
        row = np.array(
            [nodeIndexDict[trgt_key] for src_key, valdict in self.edges.iteritems() for trgt_key in valdict.iterkeys()])
